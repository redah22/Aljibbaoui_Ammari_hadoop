...
-- Cleanup Section: Remove Existing Data, Tables, and Indexes
BEGIN
...
-- Step 1: Create the Dimension Table Without Constraints Initially
...
-- Step 2: Create the Fact Table Without Constraints Initially
...
-- Step 3: Add Primary Key Indexes After Population
-- Primary Key for Dim_table_product
ALTER TABLE Dim_table_product ADD CONSTRAINT dim_product_pk PRIMARY KEY (product_id);

-- Primary Key for Fact_table_sales
ALTER TABLE Fact_table_sales ADD CONSTRAINT fact_sales_pk PRIMARY KEY (sale_id);
